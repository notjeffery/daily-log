...
interface Pkg {
  ...
  sender: { name: string; address: string; flag: string };
  receiver: { name: string; address: string; flag: string };
  weight: string;
  dimensions: string;
  type: string;
  service: string;
...
const DB: Record<string, Pkg> = {
  "DL-2024-08847": {
    id: "DL-2024-08847",
    status: "in-transit",
    sender:   { name: "James Mitchell",  address: "142 Commerce Blvd, Austin TX 78701", flag: "🇺🇸" },
    receiver: { name: "Oliver Bennett",  address: "14 Cargo Way, Heathrow, London TW6 2GW", flag: "🇬🇧" },
    weight: "2.4 kg", dimensions: "32×24×18 cm", type: "Commercial Goods", service: "Express Delivery",
    originCode: "JFK", originCity: "New York",  originCountry: "United States",
    destCode:   "LHR", destCity:   "London",    destCountry:   "United Kingdom",
    eta: "May 14, 2024",
    steps: [
      { status: "Package Received",          location: "Austin TX — DL Drop Hub",       time: "May 11 · 08:14 AM", state: "done" },
      { status: "Departed Origin Facility",  location: "JFK Airport, New York",          time: "May 11 · 02:30 PM", state: "done" },
      { status: "Customs Cleared",           location: "JFK International Freight",      time: "May 11 · 06:45 PM", state: "done" },
      { status: "In Transit — Air Freight",  location: "Transatlantic Route",            time: "May 11 · 09:00 PM", state: "active" },
      { status: "Arrived at Destination Hub",location: "Heathrow Cargo Centre, London",  time: "Est. May 13",       state: "pending" },
      { status: "Out for Delivery",          location: "London Local Courier",           time: "Est. May 14",       state: "pending" },
      { status: "Delivered",                 location: "14 Cargo Way, London",           time: "Est. May 14",       state: "pending" },
    ],
  },
  "DL-2024-05512": {
    id: "DL-2024-05512",
    status: "withheld",
    sender:   { name: "Sarah Reynolds", address: "88 Peach St, Atlanta GA 30301",        flag: "🇺🇸" },
    receiver: { name: "Klaus Hoffmann", address: "Friedrichstr. 22, Berlin 10117",        flag: "🇩🇪" },
    weight: "5.1 kg", dimensions: "45×35×28 cm", type: "Electronics", service: "Standard Worldwide",
    originCode: "ATL", originCity: "Atlanta", originCountry: "United States",
    destCode:   "BER", destCity:   "Berlin",  destCountry:   "Germany",
    eta: "Pending customs clearance",
    steps: [
      { status: "Package Received",          location: "Atlanta GA — DL Drop Hub",      time: "May 8 · 10:20 AM",  state: "done" },
      { status: "Departed Origin Facility",  location: "ATL Airport, Atlanta",           time: "May 8 · 04:00 PM",  state: "done" },
      { status: "Arrived at Frankfurt Hub",  location: "Frankfurt Airport Cargo",        time: "May 9 · 07:15 AM",  state: "done" },
      { status: "⚠ Withheld — Customs Review", location: "Frankfurt Customs Authority", time: "May 9 · 11:00 AM",  state: "active" },
      { status: "Customs Cleared",           location: "Frankfurt Customs Authority",    time: "Pending",            state: "pending" },
      { status: "Out for Delivery",          location: "Berlin Local Courier",           time: "Pending",            state: "pending" },
      { status: "Delivered",                 location: "Friedrichstr. 22, Berlin",       time: "Pending",            state: "pending" },
    ],
  },
  "DL-2024-03391": {
    id: "DL-2024-03391",
    status: "delivered",
    sender:   { name: "Derek Washington", address: "500 N Michigan Ave, Chicago IL 60611", flag: "🇺🇸" },
    receiver: { name: "Priya Nair",       address: "Plot 7, Victoria Island, Lagos",        flag: "🇳🇬" },
    weight: "1.2 kg", dimensions: "20×15×10 cm", type: "Documents", service: "Express Delivery",
    originCode: "ORD", originCity: "Chicago", originCountry: "United States",
    destCode:   "LOS", destCity:   "Lagos",   destCountry:   "Nigeria",
    eta: "Delivered May 10, 2024",
    steps: [
      { status: "Package Received",          location: "Chicago IL — DL Drop Hub",     time: "May 7 · 09:00 AM",  state: "done" },
      { status: "Departed Origin Facility",  location: "ORD Airport, Chicago",          time: "May 7 · 03:00 PM",  state: "done" },
      { status: "Customs Cleared",           location: "ORD International Freight",     time: "May 7 · 05:30 PM",  state: "done" },
      { status: "In Transit — Air Freight",  location: "Transatlantic Route",           time: "May 8 · 12:00 AM",  state: "done" },
      { status: "Arrived at Destination Hub",location: "Murtala Muhammed Airport, Lagos",time: "May 9 · 08:45 AM", state: "done" },
      { status: "Out for Delivery",          location: "Lagos Local Courier",           time: "May 10 · 07:30 AM", state: "done" },
      { status: "✅ Delivered",              location: "Plot 7, Victoria Island, Lagos",time: "May 10 · 01:14 PM", state: "done" },
    ],
  },
};
...
export default function TrackPage() {
  ...
  const DEMO_IDS = ["DL-2024-08847", "DL-2024-05512", "DL-2024-03391"];
    ...
    <>
      ...
      <nav style={{ position:"fixed", top:0, left:0, right:0, zIndex:100, display:"flex", alignItems:"center", justifyContent:"space-between", padding:"22px 60px", backdropFilter:"blur(18px)", background:"rgba(10,10,10,0.8)", borderBottom:"1px solid var(--border)" }}>
        ...
        <div style={{ display:"flex", gap:16, alignItems:"center" }}>
          ...
          <Link href="/" style={{ background:"var(--orange)", color:"#fff", padding:"10px 22px", fontSize:12, letterSpacing:"1.5px", textTransform:"uppercase", textDecoration:"none", fontWeight:600 }}>Ship Now</Link>
        </div>
      </nav>
      ...
      <div style={{ minHeight:"100vh", background:"var(--black)", color:"var(--white)", paddingTop:80 }}>
        ...
        <div style={{ background:"#0d0c0c", borderBottom:"1px solid var(--border)", padding:"72px 60px 56px", position:"relative", overflow:"hidden" }} className="tp">
          ...
          <div style={{ position:"relative", zIndex:2, maxWidth:780 }}>
            ...
            {/* Demo hints */}
            <p style={{ marginTop:14, fontSize:12, color:"var(--muted)", fontFamily:"var(--font-mono)" }}>
              Try:{" "}
              {DEMO_IDS.map((id, i) => (
                <span key={id}>
                  <span
                    style={{ color:"var(--orange)", cursor:"pointer", textDecoration:"underline", textDecorationStyle:"dotted" }}
                    onClick={() => search(id)}
                  >{id}</span>
                  {i < 2 && <span style={{ color:"var(--border)", margin:"0 8px" }}>·</span>}
                </span>
              ))}
            </p>
          </div>
        ...
        <div style={{ padding:"56px 60px" }} className="tp">
            ...
            <div style={{ marginBottom:48 }}>
              ...
              <div style={{ display:"flex", flexWrap:"wrap", gap:10 }}>
                {recents.map(id => (
                  ...
                  >
                    <span style={{ color:"var(--muted)" }}>🕐</span> {id}
                  </button>
                ))}
              </div>
            </div>
          ...
          {state === "notfound" && (
            <div style={{ background:"var(--card-bg)", border:"1px solid var(--border)", maxWidth:520, margin:"0 auto", textAlign:"center", padding:"60px 40px" }}>
              ...
              <a href="mailto:support@dailylogistics.com" style={{ display:"inline-block", background:"var(--orange)", color:"#fff", padding:"14px 32px", fontFamily:"var(--font-display)", fontSize:18, letterSpacing:2, textDecoration:"none" }}>Contact Support →</a>
            </div>
          )}
          ...
          {pkg && cfg && state !== "loading" && (
            <div>
              ...
              <div style={{ background:cfg.bg, border:`1px solid ${cfg.color}55`, padding:"20px 28px", display:"flex", alignItems:"center", gap:16, marginBottom:32, position:"relative" }}>
                ...
                {needsHelp && (
                  <a href="mailto:support@dailylogistics.com" style={{ background:"#f5a623", color:"#000", padding:"10px 22px", fontFamily:"var(--font-display)", fontSize:16, letterSpacing:1.5, textDecoration:"none", fontWeight:700, whiteSpace:"nowrap" }}>Contact Support →</a>
                )}
              </div>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 360px", gap:24 }} className="tg">
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:24 }}>
                  ...
                  <div style={{ background:"var(--card-bg)", border:"1px solid var(--border)", padding:28, position:"relative" }}>
                    ...
                    <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                      <div style={{ flex:1 }}>
                        <div style={{ fontFamily:"var(--font-display)", fontSize:48, letterSpacing:2, lineHeight:1 }}>{pkg.originCode}</div>
                        <div style={{ fontSize:13, color:"var(--muted)", marginTop:4 }}>{pkg.originCity}, {pkg.originCountry}</div>
                      </div>
                      ...
                      <div style={{ flex:1, textAlign:"right" }}>
                        <div style={{ fontFamily:"var(--font-display)", fontSize:48, letterSpacing:2, lineHeight:1 }}>{pkg.destCode}</div>
                        <div style={{ fontSize:13, color:"var(--muted)", marginTop:4 }}>{pkg.destCity}, {pkg.destCountry}</div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div style={{ display:"flex", gap:16, alignItems:"flex-start" }}>
                        ...
                        <div>
                          ...
                          <p style={{ fontSize:14, color:"var(--muted)", lineHeight:1.7, marginBottom:16 }}>
                            Your package is currently {pkg.status === "withheld" ? "withheld by customs authorities" : "delayed in transit"}. This can happen due to additional documentation, duties owed, or random inspection. Our team is monitoring the situation and will update you.
                          </p>
                          <div style={{ display:"flex", gap:12, flexWrap:"wrap" }}>
                            <a href="mailto:support@dailylogistics.com" style={{ background:"#f5a623", color:"#000", padding:"12px 24px", fontFamily:"var(--font-display)", fontSize:16, letterSpacing:1.5, textDecoration:"none", fontWeight:700 }}>Email Support →</a>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
                  ...
                  <div style={{ background:"var(--card-bg)", border:"1px solid var(--border)", padding:24, position:"relative" }}>
                    ...
                    {[{l:"Type",val:pkg.type},{l:"Weight",val:pkg.weight},{l:"Dimensions",val:pkg.dimensions},{l:"Service",val:pkg.service}].map(r=>(
                  ...
                  <div style={{ background:"var(--card-bg)", border:"1px solid var(--border)", padding:24 }}>
                    ...
                    <div style={{ display:"flex", gap:12 }}>
                      <span style={{ fontSize:22 }}>{pkg.sender.flag}</span>
                      <div>
                        <div style={{ fontSize:14, fontWeight:600, marginBottom:4 }}>{pkg.sender.name}</div>
                        <div style={{ fontSize:12, color:"var(--muted)", lineHeight:1.6 }}>{pkg.sender.address}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ background:"var(--card-bg)", border:"1px solid var(--border)", padding:24 }}>
                    ...
                    <div style={{ display:"flex", gap:12 }}>
                      <span style={{ fontSize:22 }}>{pkg.receiver.flag}</span>
                      <div>
                        <div style={{ fontSize:14, fontWeight:600, marginBottom:4 }}>{pkg.receiver.name}</div>
                        <div style={{ fontSize:12, color:"var(--muted)", lineHeight:1.6 }}>{pkg.receiver.address}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ background:"var(--card-bg)", border:"1px solid var(--border)", padding:24, textAlign:"center" }}>
                    ...
                    <a href="mailto:support@dailylogistics.com" style={{ display:"block", border:"1px solid var(--border)", color:"var(--white)", padding:12, fontFamily:"var(--font-display)", fontSize:15, letterSpacing:2, textDecoration:"none", marginBottom:10, transition:"border-color 0.2s" }}
